...
### Gapminder plots
```{r}
electricitypp <- read.csv("Indicator_Residential electricity consumption per person.csv")
electricitytotal <- read.csv("Indicator_Residential electricity consumption total.csv")
